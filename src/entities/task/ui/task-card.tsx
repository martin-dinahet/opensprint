...
type TaskKind = "task" | "bug" | "feature" | "chore";
...
export const TaskCardContent = ({
  ...
  const KindIcon = kindMeta[task.kind as TaskKind]?.icon ?? IconVersions;
  const kindLabel = kindMeta[task.kind as TaskKind]?.label ?? task.kind;
