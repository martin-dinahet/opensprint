    ...
    <div>
      <Card className="w-xs">
        <CardHeader className="space-y-1">
          <CardTitle className="font-semibold text-2xl tracking-tight">Create an account</CardTitle>
        ...
        <form action={action}>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-9 ${state.fieldErrors?.name ? "border-destructive focus-visible:ring-destructive" : ""}`}
                />
              </div>
          ...
          <CardFooter className="mt-8 flex flex-col gap-3">
            <Button type="submit" className="w-full" disabled={pending || passwordMismatch}>
              {pending ? (
                <>
